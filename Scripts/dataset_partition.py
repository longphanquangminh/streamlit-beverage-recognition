...
def iterate_dir(source, dest, ratio, copy_xml):
    ...
    if not os.path.exists(train_dir + '/annotations'):
        os.makedirs(train_dir + '/annotations')
    if not os.path.exists(test_dir + '/annotations'):
    ...
    for i in range(num_test_images):
        ...
        if copy_xml:
            ...
            copyfile(os.path.join(source, xml_filename),
                     os.path.join(test_dir + '/annotations', xml_filename))
    ...
    for filename in images:
        ...
        if copy_xml:
            xml_filename = os.path.splitext(filename)[0] + '.xml'
            copyfile(os.path.join(source, xml_filename),
                     os.path.join(train_dir + '/annotations', xml_filename))
